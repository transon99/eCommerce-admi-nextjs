      ...
      <div className="w-full h-screen flex  justify-center items-center backdrop-brightness-50">
        <div className=" px-6 py-4 sm:p-8 bg-white rounded-3xl">
          <div className="flex justify-center">
            ...
            <div className="font-bold text-gray-600 text-2xl ml-4 mb-5">
              ADMIN DASHBOARD
            </div>
          </div>
          <form
          ...
          >
            ...
            <div className="w-full flex-1 mt-8">
              {/* <div className="flex flex-col items-center">
                ...
                <button className="w-full max-w-lg font-bold shadow-sm rounded-lg py-3 bg-indigo-100 text-gray-800 flex items-center justify-center transition-all duration-300 ease-in-out focus:outline-none hover:shadow focus:shadow-sm focus:shadow-outline mt-5">
